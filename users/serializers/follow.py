...
class FollowUserSerializer(serializers.ModelSerializer):
    ...
    def validate_following_id(self, value: int) -> int:
        ...
        if following_user.status != 'ACTIVE':
...
class FollowerListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserFollow
        fields = [
            'follower_id', 'follower_username', 'follower_name',
            'follower_avatar', 'is_following_back', 'created_at'
        ]
...
class FollowingListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserFollow
        fields = [
            'following_id', 'following_username', 'following_name',
            'following_avatar', 'is_following_back', 'created_at'
        ]
