    ...
    def create(self, validated_data: Dict[str, Any]) -> User:
        ...
        try:
            ...
            user = UserService.create_user(
                ...
                **{k: v for k, v in validated_data.items() if k not in ['username', 'email', 'first_name', 'last_name', 'phone_number']}
            )
...
class UserSecuritySettingsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'two_factor_enabled', 'recovery_email', 'recovery_phone',
            'alert_on_new_device', 'alert_on_password_change',
            'alert_on_failed_login', 'created_at', 'updated_at'
        ]
