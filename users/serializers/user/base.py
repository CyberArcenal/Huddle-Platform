...
class PostStatsSerializers(rest_framework.serializers.Serializer):
    comment_count = rest_framework.serializers.IntegerField()
    like_count = rest_framework.serializers.IntegerField()
    reaction_count = rest_framework.serializers.DictField()
    privacy = rest_framework.serializers.ChoiceField(choices=feed.models.post.POST_PRIVACY_TYPES)
    comments = rest_framework.serializers.DictField()
    liked = rest_framework.serializers.BooleanField()
    current_reaction = rest_framework.serializers.StringRelatedField()
    share_count = rest_framework.serializers.IntegerField()
    
    view_count = rest_framework.serializers.IntegerField()
    moots_who_reacted = rest_framework.serializers.ListField()
    unique_viewers = rest_framework.serializers.IntegerField()
    bookmark_count = rest_framework.serializers.IntegerField()
    report_count = rest_framework.serializers.IntegerField()
    is_author = rest_framework.serializers.BooleanField()
    created_at = rest_framework.serializers.DateTimeField()
    updated_at = rest_framework.serializers.DateTimeField()
    trending_score = rest_framework.serializers.FloatField()
