...
from stories.serializers.base import StoryCleanupResponseSerializer, StoryCreateSerializer, StoryFeedSerializer, StoryHighlightSerializer, StoryRecentViewerSerializer, StoryRecommendationSerializer, StorySerializer, StoryStatsSerializer, StoryUpdateSerializer, StoryViewCountSerializer, StoryViewCreateSerializer, StoryViewSerializer
...
class StoryDetailView(APIView):
    ...
    def get_object(self, story_id):
        """Helper to get story object with permission check"""
...
class StoryViewsListView(APIView):
    ...
    def get(self, request, story_id):
        ...
        views = StoryViewService.get_story_views(story, limit=limit, offset=offset)
...
class StoryRecentViewersView(APIView):
    """Get recent viewers for a story"""
    permission_classes = [IsAuthenticated]
