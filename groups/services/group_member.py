...
class GroupMemberService:
    ...
    def get_user_groups(
        ...
        return list(queryset.order_by('-memberships__joined_at')[offset:offset + limit])
    ...
    def transfer_ownership(
        ...
        try:
            with transaction.atomic():
                ...
                current_membership = GroupMemberService.get_membership(group, current_owner)
