    ...
    def validate(self, data):
        ...
        if event_type == 'group' and not group:
            raise serializers.ValidationError({
                'group': 'Group events require a group'
            })
...
class EventListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Event
        fields = [
            'id', 'title', 'description', 'organizer', 'group',
            'event_type', 'location', 'start_time', 'end_time',
            'max_attendees', 'created_at', 'is_full',
            'attendees_count', 'user_status'
        ]
...
class EventDetailSerializer(EventListSerializer):
    ...
    class Meta:
        ...
        fields = EventListSerializer.Meta.fields + [
            'statistics', 'can_edit', 'can_delete', 'can_rsvp'
        ]
